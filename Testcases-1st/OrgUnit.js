...
describe ("Organization page ",()=>{
  const DisplayName="A Encoder001";
  const EncoderID="A Encoder-001";
    ...
    it("Check the Tooltip icons should be present-Testcase-005", async () => {
        ...
        expect(titles[1]).toEqual("Add Video Encoder");
    ...
    it("Verify that the user an update the encoder - Testcase-008", async () => {
        ...
        console.log("Testcase 008 passed-Video Encoder Successfully Updated");
      });

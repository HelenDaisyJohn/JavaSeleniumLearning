...
describe ("Channel page ",()=>{
  const fullUUID = uuidv4();
    ...
    const ConnectorID = Math.floor(Math.random() * 1000);
    ...
    it("Navigated to Channel page-testcase-002", async ()=>
    {
        browser.sleep(1000);
        await element(by.xpath("//*[@id='root']/div/div[2]/div/div/div/div[1]/button[2]")).click();
        browser.sleep(1000);
        await element(by.xpath("//p[normalize-space()='Video Channel']")).click();
    ...
    // it("Add a new Phenix Channel-testcase-004", async ()=>
    // {
    //     browser.sleep(1000);
    //     const allOrg= element(by.xpath("//button[@title='Add Video Channel']")).click();
    //     browser.sleep(2000);
    //     await element(by.xpath("//input[@id='Display-Name']")).sendKeys(DisplayName);
    //     browser.sleep(2000);
    //     await element(by.xpath("(//div[@id='Vendor'])[1]")).click();
    //     await element(by.xpath("(//li[normalize-space()='Phenix'])[1]")).click();
    //     browser.sleep(2000);
    //     await element(by.xpath("(//input[@id='Vendor-Channel-Identifier'])[1]")).sendKeys(DisplayName);
    //     browser.sleep(2000);
    //     await element(by.xpath("(//div[@id='Auto-Angle'])[1]")).click();
    //     browser.sleep(2000);
    //     await element(by.xpath("//li[normalize-space()='Backside']")).click();
    //     browser.sleep(4000);
    //     await element(by.xpath("(//input[@id='Description'])[1]")).sendKeys(DisplayName);
    //     browser.sleep(2000);
    //     await element(by.xpath("(//button[normalize-space()='Add'])[1]")).click();
    //     browser.sleep(1000);
    //     console.log("Testcase 004 passed");
    // });
    // it("Add a new Dolby Channel-testcase-004", async ()=>
    // {
    //     browser.sleep(1000);
    //     const allOrg= element(by.xpath("//button[@title='Add Video Channel']")).click();
    //     browser.sleep(2000);
    ...
    //     browser.sleep(2000);
    //     await element(by.xpath("(//div[@id='Vendor'])[1]")).click();
    //     await element(by.xpath("(//li[normalize-space()='Dolby'])[1]")).click();
    //     browser.sleep(2000);
    //     await element(by.xpath("(//input[@id='connectorId'])[1]")).sendKeys(DisplayName);
    //     browser.sleep(2000);
    //     await element(by.xpath("(//div[@id='Auto-Angle'])[1]")).click();
    //     browser.sleep(2000);
    //     await element(by.xpath("//li[normalize-space()='Backside']")).click();
    ...
    it("Add a new None Channel-testcase-004", async ()=>
    {
        browser.sleep(1000);
        const allOrg= element(by.xpath("//button[@title='Add Video Channel']")).click();
        browser.sleep(2000);
        ...
        browser.sleep(2000);
        await element(by.xpath("(//div[@id='Vendor'])[1]")).click();
        await element(by.xpath("(//li[normalize-space()='None'])[1]")).click();
        browser.sleep(2000);
        await element(by.xpath("(//div[@id='decoderName'])[1]")).click();
        browser.sleep(2000);
    ...
    it("Verify that the Updated the Channels - testcase-005", async () => {
        browser.sleep(1000);
        const firstMenu = element(by.xpath("(//div[@role='menu'])[1]"));
        await firstMenu.click();
        browser.sleep(1000);
        element(by.xpath("//li[normalize-space()='Edit']")).click();
        await element(by.xpath("//input[@id='Display-Name']")).sendKeys("123");
        await element(by.xpath("(//input[@id='Description'])[1]")).sendKeys("werr");
        browser.sleep(2000);
        ...
        expect(successMessageText).toBe("Video Channel Successfully Updated");
    ...
    it("Verify that the disable functionality is working - testcase-007", async () => {
        ...
        const successMessageText = await successMessage.getText();
        console.log(successMessageText);
        expect(successMessageText).toBe("Video Channel Successfully Disabled");
      });
      it("Verify that the Active/Inactive Channels - testcase-008", async () => {
        await element(by.xpath("//input[@name='gilad']")).click();
        console.log("All the active/Inactive Channels are visible");
      });
      it("Verify that the enable functionality is working - testcase-009", async () => {
        ...
        const successMessageText = await successMessage.getText();
        console.log(successMessageText);
        expect(successMessageText).toBe("Video Channel Successfully Enabled");
      });
      it("Verify that the delete functionality is working - testcase-010", async () => {
        ...
        const successMessageText = await successMessage.getText();
        console.log(successMessageText);
        expect(successMessageText).toBe("Video Channel Successfully Deleted");
      });
